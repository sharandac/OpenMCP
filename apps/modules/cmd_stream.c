 ...
 *
 * \ingroup modules
 * \addtogroup cmd_stream CGI-Interface zum Streamen (cmd_stream.c)
 *
 * @{
 */
...
/*------------------------------------------------------------------------------------------------------------*/
/*!\brief Registriert das CGI-Interface zu stream.
 * \param 	NONE
 * \return	NONE
 */
/*------------------------------------------------------------------------------------------------------------*/
...
//		PlayURL( http_request->argvalue[ PharseGetValue_P ( http_request, PSTR("streamurl") ) ], http_request->HTTP_SOCKET );
		PlayURL( http_request->argvalue[ PharseGetValue_P ( http_request, PSTR("streamurl") ) ] );
		printf_P( PSTR("</pre></p>"));
	}
