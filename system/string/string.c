...
/**
 * \ingroup system
 * \addtogroup STRING Stringfunktionen die man so braucht.
 *
 * @{
 */
 ...
 * \param str		Pointer auf den String der gewandelt werden soll.
 * \param bin		Pointer auf den Puffer wo die MAC-Adresse gespeichert werden soll.
 * \param lenght	Länge in HEX-Zahlen
 * \return			Rüchgabewert der Funktion.
 * \retval 0		Wandlung war erfolgreich. 
 * \retval -1		Wandlung war nicht erfolgreich. 
 */
char strtobin( char * str, char * bin, int lenght )
{
	int i;
 ...
 * \return			Rüchgabewert der Funktion.
 * \retval			!=-1 Wandlung war erfolgreich. 
 */
