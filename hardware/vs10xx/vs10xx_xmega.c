...
char VS10xx_SPI_Data( char Data )
{
	unsigned char i;
	...
	{
		// SCK auf High setzen
		VS10XX_SPI_PORT.OUTCLR = ( 1<<DOGL128_SCL_PIN);
...
char VS10xx_INIT( void )
{
	...
	printf_P( PSTR(" Clockspeed = %d.%03dMHz, SPI-Bus: %d\r\n"), (VS10xx_read( VS10xx_Register_CLOCKF ) * 2)/1000 ,  (VS10xx_read( VS10xx_Register_CLOCKF ) * 2)%1000 , SPI_BUSID );
