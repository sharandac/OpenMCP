...
/**
 * \ingroup hardware
 * \addtogroup enc28j60 Microchip ENC28J60 Ethernet Interface Driver. (enc28j60.h)
 *
 * @{
 */
...
// 	#define ENC28J60_CONTROL_CS		PE3
	...
	#define ENC28J60_INT			PORTD
	#define ENC28J60_INT_PIN		2
	#define SPIBUS					1
//	#define ENC28J60_CONTROL_PORT	PORTD.OUT
//	#define ENC28J60_CONTROL_DDR	PORTD.DIR
	#define ENC28J60_CONTROL_PORT	PORTD
	#define ENC28J60_CONTROL_CS		4
//	#define ENC28J60_RESET_PORT		PORTD.OUT
//	#define ENC28J60_RESET_DDR		PORTD.DIR
	#define ENC28J60_RESET_PORT		PORTD
	#define ENC28J60_RESET_PIN		3

#elif defined(ATXM2)

	#define ENC28J60_INT			PORTQ
	#define ENC28J60_INT_PIN		3
	#define SPIBUS					2
	#define ENC28J60_CONTROL_PORT	PORTE
	#define ENC28J60_CONTROL_CS		4
...
// In a worst cast scene, 2 Ethernetframes located into the stackspace at same time.
// One for sending (600 Byte) and one for receiving (600 Byte).
#if defined(EXTMEM)
	#define MAX_FRAMELEN	1518	// maximum ethernet frame length
#elif defined(__AVR_ATmega1284P__)
	#define MAX_FRAMELEN	1518 	// maximum ethernet frame length
#else
	#define MAX_FRAMELEN	640 	// maximum ethernet frame length
#endif
