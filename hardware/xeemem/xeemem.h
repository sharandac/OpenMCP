...
EEpromReadDWord(const void *Src)
{
 ...
 *************************************************************************/
static inline float
EEpromReadFloat(const void *Src)
{
 ...
 *************************************************************************/
static inline void *
EEpromReadBlock(void *Dst, const void *Src, size_t Len)
{
...
//  AufEinDWord.f = Val;
  ...
  EEpromWriteDWord(Dst, (uint32_t)Val);
}
/*************************************************************************
 *
